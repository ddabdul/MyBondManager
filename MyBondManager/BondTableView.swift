// BondTableView.swift
// MyBondManager
// Updated 01/05/2025 to fix expectedProfit lookup and table column binding
...
extension BondEntity {
    ...
    var expectedProfit: Double {
        // `cashFlows` is generated by Core Data as Set<CashFlowEntity>?
        let flows = cashFlows ?? []
        return flows
...
struct BondSummary: Identifiable {
    ...
    /// Sum of expectedProfit across all bonded records
    var expectedProfit: Double {
...
struct BondTableView: View {
    ...
    private var bondTable: some View {
        Table(
            ...
            // ← Fixed: explicit KeyPath on BondSummary
